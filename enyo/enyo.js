...
(function() {
var a = "enyo";
enyo = window.enyo || {}, enyo.args = enyo.args || {}, enyo.args.main = a;
var b = a + ".js", c = function(a) {
var b = document.getElementsByTagName("script");
for (var c = 0, e, f, g = a.length; e = b[c]; c++) {
f = e.getAttribute("src") || "";
if (f.slice(-g) == a) return d(e), f.slice(0, -g - 1);
}
}, d = function(a) {
for (var b, c = 0, d = a.attributes.length; c < d; c++) b = a.attributes.item(c), enyo.args[b.nodeName] = b.nodeValue;
};
enyo.args.root = (enyo.args.root || c(b)).replace("/source", "");
})();
...
c.slice(-8) == "-depends" ? this.manifest = d + c + ".js" : (d = d + c + "/", this.manifest = d + "depends.js");
...
var a = enyo.loader;
if (!a.packageFolder) {
var b = enyo.locateScript("depends.js");
...
this._send("mousedown", a.changedTouches[0]), !a.target || a.target.nodeName == "INPUT" || a.target.nodeName == "A" || a.target.nodeName == "SELECT";
},
