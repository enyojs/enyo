...
/**
* Contains the declaration for the {@link enyo.Binding} kind.
* @module enyo/Binding
*/
...
* {@link module:enyo/Binding.find} method using an {@link enyo.Binding#id} identifier.
*
* @type {enyo.Binding[]}
* @default []
* @public
