...
* @param {enyo.Collection} collection - The [collection]{@link module:enyo/Collection~Collection}
...
* @param {enyo.Model} a - The first [model]{@link module:enyo/Model~Model} to compare.
...
* @mixes module:enyo/StateSupport
...
exports = module.exports = kind(
	...
	*/
	...
	/**
	* The configurable default [options]{@link module:enyo/Collection~Collection~Options}. These values will be
	...
	* if the [parse]{@link module:enyo/Collection~Collection~Options.parse} flag is set to `true`.
	...
	* See {@link module:enyo/Collection~Collection~AddOptions} for detailed information on the
	...
	*	hashes, an {@link module:enyo/Model~Model} instance, or and array of `enyo.Model` instances.
	...
	* @param {(enyo.Model|enyo.Model[])} models The [models]{@link module:enyo/Model~Model} to remove		
	...
	* @returns {(enyo.Model|undefined)} The [model]{@link module:enyo/Model~Model} at the given index or
	...
	*
	* @returns {enyo.Model[]} The [models]{@link module:enyo/Model~Model} according to their
	...
	* [collection]{@link module:enyo/Collection~Collection}.
	*
	* @param {enyo.Model} model - The [model]{@link module:enyo/Model~Model} to check.
	...
	* 
	* @param {(enyo.Model|enyo.Model[])} [models] The [model or models]{@link module:enyo/Model~Model}
	...
	* @see {@glossary Array.sort}
	* @param {enyo.Collection~Comparator} [fn] - The [comparator]{@link module:enyo/Collection~Collection#comparator}
	* method.
	...
	* ({@link module:enyo/StateSupport.isError}) or [busy]{@link module:enyo/States.BUSY}
	* ({@link module:enyo/StateSupport.isBusy}) [state]{@link module:enyo/Model~Model#status}. While
	...
	* [error]{@link module:enyo/States.ERROR} ({@link module:enyo/StateSupport.isError}) or
	* [busy]{@link module:enyo/States.BUSY} ({@link module:enyo/StateSupport.isBusy})
	...
	* [error handler]{@link module:enyo/Collection~Collection~ErrorCallback}. If the error handler
