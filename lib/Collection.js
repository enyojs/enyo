...
*	collection that [emitted]{@link module:enyo/EventEmitter#emit} the event.
...
* @property {module:enyo/Collection~Collection} collection - A reference to the
*	[collection]{@link module:enyo/Collection~Collection} that [emitted]{@link module:enyo/EventEmitter#emit} the event.
...
exports = module.exports = kind(
	...
	* [emit]{@link module:enyo/EventEmitter#emit} a [reset]{@link module:enyo/Collection~Collection#reset}
	* event.
	*
	...
	* [emits]{@link module:enyo/EventEmitter#emit} the [sort]{@link module:enyo/Collection~Collection#sort}
	* event.
	*
