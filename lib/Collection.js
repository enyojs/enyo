...
exports = module.exports = kind(
	...
	* @param {module:enyo/Collection~Collection~AddOptions} [opts] - The configuration options that modify
	...
	* @param {module:enyo/Collection~Collection~Options} [opts] - The options that will modify the behavior
	*	of this method.
	...
	* method.
	* @param {module:enyo/Collection~Collection~Options} [opts] - The configuration options.
