...
var Control = module.exports = kind(
	...
	*
	* This is a shortcut convenience method for {@link module:enyo/dom~dom.getBounds}.
	*
	...
	*
	* This is a shortcut convenience method for {@link module:enyo/dom~dom.getAbsoluteBounds}.
	*
	* @returns {Object} An [object]{@glossary Object} containing `top`, `left`,
	* `width`, and `height` properties.
	* @public
	...
	* when working with {@link module:enyo/List~List}. (Because {@link module:enyo/List~List} is
