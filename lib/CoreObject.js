...
* {@glossary mixin}), and data binding (via the {@link module:enyo/BindingSupport} mixin and
...
var CoreObject = module.exports = kind(
	...
	* [enyo.getPath()]{@link module:enyo/getPath~getPath} for complete details.
	*
	...
	* [enyo.setPath()]{@link module:enyo/setPath~setPath} for complete details.
	*
	...
	*
	* This method should generally be used instead of {@link module:enyo/bind~bind} for running
