...
* @property {module:enyo/DataList~PagingEvent} event - A [hash]{@glossary Object} with properties
...
* [addListener()]{@link module:enyo/EventEmitter#addListener} and specifying the event,
...
var DataList = module.exports = kind(
	...
	*/
	...
	/**
	* Adds the [EventEmitter]{@link module:enyo/EventEmitter} [mixin]{@glossary mixin}
