...
var DataRepeater = module.exports = kind(
	...
	*
	* @param {enyo.Model} rec - The [record]{@link module:enyo/Model~Model} to add.
	...
	* @returns {enyo.Control|undefined} The [control]{@link module:enyo/Control~Control} at the specified
	...
	*
	* @returns {enyo.Collection} The {@link module:enyo/Collection~Collection} that comprises the data.
	* @public
	*/
	data: function () {
	...
	*
	* @param {enyo.Model} model - The [model]{@link module:enyo/Model~Model} whose selection status
	* is to be determined.
