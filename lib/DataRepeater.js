...
var DataRepeater = module.exports = kind(
	...
	*/
	_initSelection: function() {
		...
		this._selection = dd.filter(this.bindSafely('_filterSelection'));
	},
	
	/**
	* @private
	*/
	_filterSelection: function(d) {
		var _selected = d.get(this.selectionProperty) == true;
		if (this._filtered) {
			d.set(this.selectionProperty, false);
			return false;
		}
		if (this.selectionType != 'multi' && _selected == true) this._filtered = true;
		return _selected;
	},
