...
/**
* {@link module:enyo/EventEmitter} is a {@glossary mixin} that adds support for
...
* When [emitted]{@link module:enyo/EventEmitter.emit}, these events **do not bubble**
* and will only be handled by [registered listeners]{@link module:enyo/EventEmitter.on}.
*
...
module.exports = {
	...
	* semaphor and [unsilence()]{@link module:enyo/EventEmitter.unsilence} will need to
	* be called the same number of times that this method is called.
	*
	* @see module:enyo/EventEmitter.unsilence
	...
	* that [silence()]{@link module:enyo/EventEmitter.silence} was called.
	*
	* @see module:enyo/EventEmitter.silence
	* @returns {this} The callee for chaining.
	* @public
	*/
	...
	/**
	* Determines whether the callee is currently [silenced]{@link module:enyo/EventEmitter.silence}.
	*
	* @returns {Boolean} Whether or not the callee is
	*	[silenced]{@link module:enyo/EventEmitter.silence}.
	* @public
	*/
	isSilenced: function () {
	...
	*/
	...
	/**
	* Adds an {@glossary event} listener. Until [removed]{@link module:enyo/EventEmitter.off},
	* this listener will fire every time the event is
	* [emitted]{@link module:enyo/EventEmitter.emit}.
	*
