...
/**
* Contains the declaration for the {@link module:enyo/JsonpRequest~JsonpRequest} kind.
* @module enyo/Jsonp
*/
...
/**
* {@link module:enyo/JsonpRequest~JsonpRequest} is an [Async]{@link module:enyo/Async~Async} task specifically designed
...
var JsonpRequest = module.exports = kind(
	/** @lends module:enyo/JsonpRequest~JsonpRequest.prototype */ {
	...
	*/
	published: {
		...
		*
		* @see module:enyo/JsonpRequest~JsonpRequest.overrideCallback
		* @memberof enyo.JsonpRequest.prototype
		* @type {String}
		* @default 'callback'
		* @public
		...
		* [callback]{@link module:enyo/JsonpRequest~JsonpRequest#callback} names, this property may be used to
		...
		* name and only one [JsonpRequest]{@link module:enyo/JsonpRequest~JsonpRequest} using this property may
		* be active at a time.
		*
		* @memberof enyo.JsonpRequest.prototype
		* @type {String}
