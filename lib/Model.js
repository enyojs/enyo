...
var Model = module.exports = kind(
	...
	* By default, a model is [NEW]{@link enyo~States.NEW} and [CLEAN]{@link module:enyo/States~States.CLEAN}.
	...
	* @param {module:enyo/Model~Model~Options} [opts] - If `path` is a string, this should be the
