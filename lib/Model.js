...
* @param {enyo.Model} model - The [model]{@link module:enyo/Model~Model} that is returning successfully.
...
var Model = module.exports = kind(
	...
	*/
	...
	/**
	* The current [state(s)]{@link enyo~States} possessed by the [model]{@link module:enyo/Model~Model}.
	...
	* [error]{@link enyo~States.ERROR} ({@link module:enyo/StateSupport~StateSupport.isError}) or
	* [busy]{@link enyo~States.BUSY} ({@link module:enyo/StateSupport~StateSupport.isBusy})
	...
	* [error]{@link enyo~States.ERROR} ({@link module:enyo/StateSupport~StateSupport.isError})
	* or [busy]{@link enyo~States.BUSY} ({@link module:enyo/StateSupport~StateSupport.isBusy})
	* [state]{@link module:enyo/Model~Model#status}. While executing, it will add the
	...
	* @param {enyo.Model~Options} [opts] - This is a one-time [options hash]{@link module:enyo/Model~Model~Options} that
