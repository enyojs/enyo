...
new ScrimSingleton('scrim', {floating: true, classes: 'enyo-scrim-translucent'});
new ScrimSingleton('scrimTransparent', {floating: true, classes: 'enyo-scrim-transparent'});
