...
var StateSupport = {
	...
	*/
	...
	/**
	* Will remove any [error flags]{@link module:enyo/States~States~ERROR} from the given
	...
	* (or the optional passed-in value) is an [error state]{@link module:enyo/States~States~ERROR}.
	...
	*	[error state]{@link module:enyo/States~States~ERROR}.
	* @returns {Boolean} Whether the value is an [error state]{@link module:enyo/States~States~ERROR} or not.
	* @public
	*/
	...
	* Convenience method to avoid using [bitwise]{@glossary bitwise} comparison for the
	* [status]{@link module:enyo/StateSupport~StateSupport~status}. Determines whether the current status
	* (or the optional passed-in value) is a [busy state]{@link module:enyo/States~States~BUSY}. The
	...
	*	[busy state]{@link module:enyo/States~States~BUSY}.
	* @returns {Boolean} Whether the value is a [busy state]{@link module:enyo/States~States~BUSY} or not.
	* @public
	*/
	...
	* Convenience method to avoid using [bitwise]{@glossary bitwise} comparison for the
	* [status]{@link module:enyo/StateSupport~StateSupport~status}. Determines whether the current status
	* (or the optional passed-in value) is a [ready state]{@link module:enyo/States~States~READY}. The
	* passed-in value will only be used if it is a [Number]{@glossary Number}.
	*
	* @param {module:enyo/States} [status] - The specific value to compare as a
	*	[ready state]{@link module:enyo/States~States~READY}.
	* @returns {Boolean} Whether the value is a [ready state]{@link module:enyo/States~States~BUSY} or not.
	* @public
	*/
