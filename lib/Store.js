...
* @param {enyo.Model} model - The [model]{@link module:enyo/Model~Model} to filter.
...
var Store = kind(
	...
	*
	* @param {(Function|enyo.Model)} ctor Can be the constructor for an {@link module:enyo/Model~Model}
