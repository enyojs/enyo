...
* of an `enyo.Scroller` or {@link module:enyo/List~List}, or is used by the framework implicitly.
*
...
module.exports = kind(
	...
	*
	* @param {enyo.Control} ctl - The [control]{@link module:enyo/Control~Control} to make visible in the
