...
*
* @event module:enyo/TransitionScrollStrategy~TransitionScrollStrategy#onScrollStart
* @type {Object}
...
*
* @event module:enyo/TransitionScrollStrategy~TransitionScrollStrategy#onScroll
* @type {Object}
* @property {Object} sender - The [component]{@link module:enyo/Component~Component} that most recently
*	propagated the {@glossary event}.
* @property {module:enyo/Scroller~ScrollEvent} event - An [object]{@glossary Object} containing
...
*
* @event module:enyo/TransitionScrollStrategy~TransitionScrollStrategy#onScrollStop
* @type {Object}
* @property {Object} sender - The [component]{@link module:enyo/Component~Component} that most recently
*	propagated the {@glossary event}.
* @property {module:enyo/Scroller~ScrollEvent} event - An [object]{@glossary Object} containing
...
/**
* {@link module:enyo/TransitionScrollStrategy~TransitionScrollStrategy} is a helper [kind]{@glossary kind} that extends
...
* an {@link module:enyo/Scroller~Scroller} or {@link module:enyo/List#List}, or is used by the framework implicitly.
*
...
var TransitionScrollStrategy = module.exports = kind(
	/** @lends module:enyo/TransitionScrollStrategy~TransitionScrollStrategy.prototype */ {
	...
	*/
	intervalChanged: function () {
		...
		if (this.interval != TransitionScrollStrategy.prototype.interval) {
	...
	*/
	...
	/**
	* @fires module:enyo/TransitionScrollStrategy~TransitionScrollStrategy#onScroll
	* @private
	*/
	...
	* {@glossary event}.
	*
	* @fires module:enyo/TransitionScrollStrategy~TransitionScrollStrategy#onScrollStart
	* @private
	*/
	start: function () {
		this.startScrolling();
	...
	* {@glossary event}.
	*
	* @fires module:enyo/TransitionScrollStrategy~TransitionScrollStrategy#onScrollStop
	* @private
	*/
	stop: function () {
		if(this.isScrolling()) {
	...
	*/
	updateX: function () {
		var x = global.getComputedStyle(this.$.client.node,null).getPropertyValue(Dom.getCssTransformProp()).split('(')[1];
	...
	*/
	updateY: function () {
		var y = global.getComputedStyle(this.$.client.node,null).getPropertyValue(Dom.getCssTransformProp()).split('(')[1];
	...
	/**
	* Applies transform to scroll the [scroller]{@link module:enyo/Scroller~Scroller}.
	*
	* @private
	*/
	...
	*/
	...
	/**
	* Moves [scroller]{@link module:enyo/Scroller~Scroller} based on user's dragging.
	*
	* @private
	*/
	...
	*/
	...
	/**
	* When user flicks/throws [scroller]{@link module:enyo/Scroller~Scroller}, calculates the distance to be 
	...
	*/
	resetCSSTranslationVals: function () {
		var prop = Dom.getCssTransformProp();
		var transformStyle = global.getComputedStyle(this.$.client.node,null).getPropertyValue(prop).split('(')[1].split(')')[0].split(',');
