...
var UiComponent = module.exports = kind(
	...
	*
	* @method
	* @param {enyo.Control} ancestor - The [control]{@link module:enyo/Control~Control} whose lineage
	...
	*
	* @method
	* @returns {enyo.Control[]} An [array]{@glossary Array} of [controls]{@link module:enyo/Control~Control}.
	* @public
	*/
	...
	*
	* @method
	* @returns {enyo.Control | null} The [control]{@link module:enyo/Control~Control} that is the] following
