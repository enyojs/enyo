...
/**
* Contains the declaration for the [enyo/VerticalGridDelegate]{@link module:enyo/VerticalGridDelegate} module.
...
/**
* This is a {@glossary delegate} (strategy) used by {@link enyo.DataGridList}
...
* @type Object
* @definedby module:enyo/VerticalGridDelegate
* @private
*/
...
kind.extendMethods(p, {
	...
	*/
	...
	/**
	* This method calculates the number of [controls]{@link enyo.Control} necessary
