...
/**
* Contains the declaration for the {@link enyo.ViewController} kind.
...
* @definedby module:enyo/ViewController
* @public
*/
module.exports = kind(
	...
	render: function (target) {
		...
		if (v) {
			...
			if (this.container) {
				...
				v.renderInto(Dom.byId(t) || utils.getPath(t));
			}
		}
	},
	...
	*/
	viewChanged: function (previous) {
		...
		if (typeof this.viewKind == 'string') {
			this.viewKind = utils.getPath(this.viewKind);
		}
