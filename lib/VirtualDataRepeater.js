...
/**
* Contains the declaration for the {@link enyo.VirtualDataRepeater} kind.
...
/**
* @namespace enyo
* @class enyo.VirtualDataRepeater
* @extends enyo.DataRepeater
* @definedby module:enyo/VirtualDataRepeater
* @public
*/
module.exports = kind({
	...
	doIt: function(immediate) {
		...
		// THIS WON'T WORK AS AN OPTIONAL DEPENDENCY BUT THIS IS ALL WIP SO LEAVING FOR NOW
		// UNTIL A MORE SUITABLE PATTERN IS ESTABLISHED
		if (Spotlight) {
			sp = Spotlight.getCurrent();
		}
