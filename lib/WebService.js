...
* @type {Object}
* @property {enyo.Async} ajax - The {@link module:enyo/Async~Async} instance associated with the request.
...
* ({@link module:enyo/Ajax~Ajax} and {@link module:enyo/JsonpRequest~JsonpRequest}) to manage transactions.
*
...
module.exports = kind(
	...
	*/
	published: {
		...
		* {@link module:enyo/JsonpRequest~JsonpRequest} instead of {@link module:enyo/Ajax~Ajax}).
		*
	...
	* @returns {enyo.Async} The associated {@link module:enyo/Async~Async} instance.
	* @public
	*/
