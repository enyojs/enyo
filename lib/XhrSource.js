...
/**
* Contains the declaration for the {@link enyo.XhrSource} kind.
...
* @extends enyo.Source
* @definedby module:enyo/XhrSource
* @public
*/
var XhrSource = module.exports = kind(
	...
	* tandem with {@link enyo.Model#url} and {@link enyo.Collection#url} to build
	* a complete path.
	*
	* @type {String}
	* @default ''
	...
	* [requestKind]{@link module:enyo/XhrSource.requestKind}.
	*
	...
	*	[buildUrl()]{@link module:enyo/XhrSource.buildUrl} and possessing `method` and `attributes`
	*	properties.
	* @public
	*/
