...
* details, see the same properties defined on {@link module:enyo/dev~dev.Benchmark}.
* 
* @typedef  {Object} module:enyo/dev~Benchmark~Options
* @property {String} name - The referenceable name of the
* [benchmark]{@link module:enyo/dev~dev.Benchmark} (used for reporting).
...
exports = module.exports = {
	...
	*/
	...
	/**
	* Creates a new [benchmark]{@link module:enyo/dev~dev.Benchmark} test with the given
	* configuration options.
	*
	* @param {module:enyo/dev~Benchmark~Options} opts - The configuration
	* [options]{@link module:enyo/dev~dev.Benchmark~Options} to apply to the
	* [benchmark]{@link module:enyo/dev~dev.Benchmark}.
	* @returns {module:enyo/dev~Benchmark} A Benchmark instance with `start()` and
	...
	*/
	...
	/**
	* Shows a report for a given [benchmark]{@link module:enyo/dev~dev.Benchmark} by name.
	*
	* @param {String} name - The name of the [benchmark]{@link module:enyo/dev~dev.Benchmark} to report.
	* @public
	*/
	...
	/**
	* Removes all stored data related to the named [benchmark]{@link module:enyo/dev~dev.Benchmark}.
	*
	* @param {String} name - The name of the [benchmark]{@link module:enyo/dev~dev.Benchmark} from which to
	*	remove stored data.
	* @public
	*/
	clear: function (name) {
...
*
* @class module:enyo/dev~Benchmark
* @protected
*/
var Benchmark = exports.Benchmark = kind(/** @lends module:enyo/dev~dev.Benchmark.prototype */ {
