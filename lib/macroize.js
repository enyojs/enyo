...
* @public
*/
var macroize = module.exports = function (text, map, regex) {
	var v, working, result = text, pattern = regex || macroize.pattern;
...
* {@glossary String}. This is just like [enyo.macroize()]{@link module:enyo/macroize},
...
* @public
*/
macroize.quickReplace = function (text, map, pattern) {
	pattern = pattern || macroize.pattern;
...
/**
* A non-recursing version of [enyo.macroize()]{@link module:enyo/macroize}. This means it
...
* @public
*/
macroize.quickMacroize = function(text, map, regex) {
	var v, result = text, pattern = regex || macroize.pattern;
	var fn = function(macro, name) {
		if (name in map) {
			v = map[name];
		} else {
...
* [enyo.macroize()]{@link module:enyo/macroize}, [enyo.quickReplace()]{@link enyo.quickReplace},
* and [enyo.quickMacroize()]{@link module:enyo/quickMacroize}. Matches macros of the form
* `{$name}`.
*
* @type {RegExp}
* @default '/\{\$([^{}]*)\}/g'
