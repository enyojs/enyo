...
* that returns the new that will be called instead of the original function. The original is
* available as the first argument to that factory function.
*
* ```javascript
* var
...
* @param {Object} [ctx] - Context on which `fn` will be called. Defaults to the Expendable instance.
