enyo.kind({
	...
	components: [
		{name: "sampleContent", classes: "fullscreen-sample-container", components: [
			{kind: "onyx.GroupboxHeader", content: "Fullscreen Sample"},
			{kind: "enyo.Scroller", classes: "fullscreen-sample-scroller", components: [
			...
			{kind: "onyx.Button", content: "Toggle Fullscreen", ontap: "toggleFullscreen"}
		]}
	],
