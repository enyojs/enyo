(function (enyo, scope) {
	...
	/**
	* An [XHR2]{@linkplain http://www.w3.org/TR/XMLHttpRequest/} FormData implementation. It is used
	* to send `multipart/form-data` [Ajax]{@glossary ajax} requests. The internal `enyo.Blob`
