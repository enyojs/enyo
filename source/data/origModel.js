	...
	enyo.kind({
		...
		*/
		didFetch: function (options, result, noFilter) {
			...
			var b = enyo.dev.bench({name: "PreFlush", logging: false});
			...
			if ($k.length) {
				if (!this.__hasFetched) {
					var p = enyo.dev.bench({name: "createSchema", logging: false});
			...
			b.stop();
			var c = enyo.dev.bench({name: "FlushingAction", logging: false});
		...
		*/
		constructor: function (values) {
			var b = enyo.dev.bench({name: "enyo.Model.constructor", logging: false});
			...
			var d = enyo.dev.bench({name: "didFetch", logging: false});
