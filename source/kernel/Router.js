	...
	*/
	enyo.kind(
		...
		*/
		...
		/**
		* If `true`, the router will not trigger listeners to hashchanges that are the result of
		* calling location(hash).
		*
		* @type {Boolean}
		* @default false
		* @public
		...
		location: function (loc) {
			if (loc) {
				...
				if (!this.internalOnly) {
					// mark this hashchange as self-induced
		...
		*/
		_hashChanged: function (hash) {
			// ignore hashchaned that were generated by calling location(hash)
			if(this.ignoreSelf && this.selfChanged){
