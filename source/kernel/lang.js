(function(){
	...
	*/
	...
	//*@protected
	/**
		Internally-used method to detect if the given value exists, is a function,
		and is an overloaded getter. Returns true if these conditions are met; false
		otherwise.
	*/
	...
	*/
	...
	/**
		...
		properties. Performs an optimized recursive search.	Returns _undefined_ if
		the object at the given path cannot be found. May safely be called on
		non-existent paths.
	*/
	enyo.getPath = function (path) {
		...
		// if there aren't any, try and find the path relative to our
	...
	/**
		...
		will be triggered regardless. Optionally, the third parameter may be a
