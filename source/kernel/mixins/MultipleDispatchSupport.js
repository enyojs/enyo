//*@public
/**
	Allow a single object to dispatch its events to multiple registered
	listeners. Note that events generated by the object will be dispatched
	to all listeners but events bubbled/dispatched the object will only
	be propagated if the object has an _owner_. The _owner_ property can
	be set at any time, however, if a _view_ initializes a new instance of
	the kind its _owner_ will automatically be set.
*/
enyo.createMixin({
	...
	*/
	...
	//*@public
	/**
		Accepts an instance of any _enyo.Component_ or subkind that
		supports the event API.
	*/
	...
	//*@public
	/**
		Accepts an instance of a registered listener on this object
		and will remove it from active dispatch targets if it is
		present.
	*/
