...
/**
* Contains the declaration for the {@link module:enyo/LocalStorageSource~LocalStorageSource} kind.
* @module enyo/LocalStorageSource
*/
...
if (typeof localStorage != 'undefined') {
	...
	/**
	* A [localStorage]{@glossary localStorage} [source]{@link module:enyo/Source~Source}. This
	...
	* [primaryKey]{@link module:enyo/Model~Model#primaryKey}.
	*
	...
	*/
	module.exports = kind(
		/** @lends module:enyo/LocalStorageSource~LocalStorageSource.prototype */ {
		...
		*/
		...
		/**
		* The namespace of all [models]{@link module:enyo/Model~Model} and
		* [collections]{@link module:enyo/Collection~Collection} that will be stored by this
		* {@link module:enyo/LocalStorageSource~LocalStorageSource}.
		*
		* @type {String}
		* @default 'enyo-app'
		* @public
		...
		commit: function (model, opts) {
			...
			if (model instanceof Collection) {
				...
				storage.collections[id] = model.map(function (model) {
					...
					return model.attributes[model.primaryKey] || (model.attributes[model.primaryKey] = utils.uuid());
				});
			}
			
			else if (model instanceof Model) {
				// we automatically assign a uuid here to ensure that it will be commited in a trackable way
				if (!(id = model.attributes[model.primaryKey])) id = (model.attributes[model.primaryKey] = utils.uuid());
