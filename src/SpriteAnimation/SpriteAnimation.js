...
/**
* Contains the declaration for the {@link module:enyo/SpriteAnimation~SpriteAnimation} kind.
...
var
	...
	EnyoImage = require('../Image'),
	StylesheetSupport = require('../StylesheetSupport');

/**
* {@link module:enyo/SpriteAnimation~SpriteAnimation} is a basic animation [component]{@link module:enyo/Component~Component}.
* Call `play()` to start the animation. The animation will run for the period
* of time (in milliseconds) specified by its [duration]{@link module:enyo/SpriteAnimation~SpriteAnimation#duration}.
*
...
*/
module.exports = kind(
	/** @lends module:enyo/SpriteAnimation~SpriteAnimation.prototype */ {
	...
	*/
	published:
		...
		* [duration]{@link module:enyo/SpriteAnimation~SpriteAnimation#duration} specified.
		*
		* @type {String}
		* @default ''false''
		* @public
		...
		* There's also a [pause()]{@link module:enyo/SpriteAnimation~SpriteAnimation#pause} method for convenience.
		*
		* @type {Boolean}
		* @default false
		* @public
		...
		* [iterationCount]{@link module:enyo/SpriteAnimation~SpriteAnimation#iterationCount}), and stop at the last
	...
	*/
	components: [
		{kind: EnyoImage, name: 'spriteImage', classes: 'enyo-sprite-animation-image', mixins: [StylesheetSupport], sizing: 'cover'}
	],
	...
	*/
	...
	/**
	* Links the pause property to the [pause]{@link module:enyo/SpriteAnimation~SpriteAnimation#pause} method.
	*
	* @private
	*/
