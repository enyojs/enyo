...
* details, see the same properties defined on {@link module:enyo/dev~Benchmark}.
* 
* @typedef  {Object} module:enyo/dev~Benchmark~Options
* @property {String} name - The referenceable name of the
* [benchmark]{@link module:enyo/dev~Benchmark} (used for reporting).
...
exports = module.exports = {
	...
	*/
	...
	/**
	* Creates a new [benchmark]{@link module:enyo/dev~Benchmark} test with the given
	* configuration options.
	*
	* @param {module:enyo/dev~Benchmark~Options} opts - The configuration
	* [options]{@link module:enyo/dev~Benchmark~Options} to apply to the
	* [benchmark]{@link module:enyo/dev~Benchmark}.
	...
	*/
	...
	/**
	* Shows a report for a given [benchmark]{@link module:enyo/dev~Benchmark} by name.
	*
	* @param {String} name - The name of the [benchmark]{@link module:enyo/dev~Benchmark} to report.
	* @public
	*/
	...
	/**
	* Removes all stored data related to the named [benchmark]{@link module:enyo/dev~Benchmark}.
	*
	* @param {String} name - The name of the [benchmark]{@link module:enyo/dev~Benchmark} from which to
	*	remove stored data.
	* @public
	*/
	clear: function (name) {
...
* @protected
*/
var Benchmark = exports.Benchmark = kind(/** @lends module:enyo/dev~Benchmark.prototype */ {
